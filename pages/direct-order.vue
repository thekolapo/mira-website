<template>
  <div class="order">
    <section class="order__hero">
      <h1 class="u-font-h1">Powerful ordering solution for delivery</h1>
      <p class="order__hero-subtext">
        Turn your social media or website into a selling machine. Let your best
        customers order directly from Instagram or WhatsApp. Say hello to
        another direct revenue stream.
      </p>
